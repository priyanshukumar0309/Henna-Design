    ...
    try {
      ...
      if (!data || data.length === 0) {
        const fallbackImages: PortfolioImage[] = [
          ...
          {
            id: '14',
            title: 'Elegant Hand Design with Ring',
            description: 'Beautiful henna design featuring intricate patterns on hand with elegant ring accessory',
            ...
            category: 'bridal',
            tags: ['elegant', 'hand', 'ring', 'bridal', 'traditional'],
            featured: true,
            display_order: 14,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString()
          ...
          {
            id: '17',
            title: 'Bridal Arm Art Collection',
            description: 'Elaborate bridal henna featuring full arm design with traditional and modern elements',
            ...
            category: 'bridal',
            tags: ['bridal', 'full-arm', 'elaborate', 'traditional', 'modern'],
            featured: true,
            display_order: 17,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString()
          ...
          {
            id: '18',
            title: 'Festival Hand Patterns',
            description: 'Vibrant festival henna design with colorful patterns perfect for celebrations',
            ...
            category: 'festival',
            tags: ['festival', 'vibrant', 'colorful', 'celebration', 'hand'],
            featured: true,
            display_order: 18,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString()
          },
          {
            ...
            category: 'minimalist',
            tags: ['contemporary', 'minimalist', 'wrist', 'modern', 'elegant'],
            featured: true,
            display_order: 19,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString()
          ...
          {
            id: '20',
            title: 'Traditional Hand Art',
            description: 'Classic henna patterns showcasing traditional Indian mehndi artistry',
            ...
            category: 'festival',
            tags: ['traditional', 'classic', 'indian', 'mehndi', 'hand'],
            featured: true,
            display_order: 20,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString()
          ...
          {
            id: '22',
            title: 'Artistic Forearm Collection',
            description: 'Creative henna artistry featuring flowing patterns and artistic expression on forearm',
            ...
            category: 'photoshoot',
            tags: ['artistic', 'forearm', 'creative', 'flowing', 'collection'],
            featured: true,
            display_order: 22,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString()
          ...
          {
            id: '23',
            title: 'Elegant Hand Design',
            description: 'Beautiful henna design perfect for special occasions and celebrations',
            ...
            category: 'bridal',
            tags: ['elegant', 'hand', 'special-occasion', 'beautiful', 'celebration'],
            featured: true,
            display_order: 23,
            created_at: new Date().toISOString(),
            updated_at: new Date().toISOString()
