      ...
      const fallbackImages: PortfolioImage[] = [
        {
          ...
          image_url: 'https://www.pexels.com/sv-se/foto/kvinna-hand-design-konstnarlig-4161384/',
          thumbnail_url: 'https://www.pexels.com/sv-se/foto/kvinna-hand-design-konstnarlig-4161384/',
          category: 'bridal',
          tags: ['bridal', 'minimalist', 'nordic'],
          featured: true,
          display_order: 1,
